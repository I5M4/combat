...
class _model {
    ...
    function html($nomChamp){
        ...
        if(!empty($this->valeur[$nomChamp])){
            ...
            if($this->typeChamp[$nomChamp] == "categorie"){
                ...
                return nl2br(htmlentities($this->valCategorie[$nomChamp]));
    ...
    function getAll($tri=null){
        //role : recupérer toutes les lignes (avec ou sans filtre )
        //param: (optionnel):$champ, le champ par lequel on va trier
        //     :    (optionnel) : $tri , la condition de tri 
