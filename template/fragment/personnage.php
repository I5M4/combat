...
<?php $objet->get("salle") <= 1  ? "" : include "template/fragment/button_reculer.php" ?>
<?php $objet->get("salle") >= 10 ? "" : include "template/fragment/button_avancer.php" ?>
<table style="margin-top: 15px;  padding: 20px;">
    <?= empty($listeAdversaires) ? "<p> Vous êtes seul dans cette salle ... <p>" : "" ?>
    <?php foreach ($listeAdversaires as $adversaire) {
        include "template/fragment/liste_adversaire.php";
    } ?>
</table>
</div>